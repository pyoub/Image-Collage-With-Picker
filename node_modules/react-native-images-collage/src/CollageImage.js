  ...
  render() {
    ...
    return (
        <View
            ...
            {this.props.isButtonVisible && (<View style={{position:"absolute",width:50,height:50,borderRadius:25,zIndex:98}}>
            <TouchableWithoutFeedback onPress={this.props.onPress} >
              <Image style={{position:"relative",width:50,height:50}} source={this.props.img}/>
