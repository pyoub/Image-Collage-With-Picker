    ...
    return (
        <View
            ...
            {this.props.isButtonVisible && (
              <View ref={this.props.setRef} style={{position:"absolute",width:50,height:50,borderRadius:25,zIndex:98}}>
                <TouchableWithoutFeedback onPress={this.props.onPress} >
                  <Image style={{paddingLeft:5,paddingTop:5, position:"relative",width:50,height:50,display:this.props.imgDisplay === 'none' ? 'none' : 'flex'}} source={this.props.img}/>
...
CollageImage.propTypes = {
  ...
  panningRightPdding: PropTypes.number.isRequired, // RIGHT PANNING PADDING
